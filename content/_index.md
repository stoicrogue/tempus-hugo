...
**Middle Sessions (Sessions 10-25):** In an effort to be more present at the table, I changed my approach and worked off printed notes—one or two pages if I could get away with it. I also ported my prep from Notion to Obsidian around this time.  The structure became consistent: a Strong Start to kick off the session, a list of possible Scenes, Secrets & Clues to reveal, and key NPCs/Monsters. I took handwritten notes during play and transferred anything important back to Obsidian afterward.
